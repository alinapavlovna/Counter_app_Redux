...
export default connect(mapStateToProps, actions)(Counter);//связывает хранилище store с компонентом Counter
...
export default connect(mapStateToProps, mapDispatchToProps)(Counter);//связывает хранилище store с компонентом Counter
